...
class ControllerExtensionModuleDQuickcheckout extends Controller {
    ...
    public function __construct($registry) {
        ...
        $this->extension = json_decode(file_get_contents(DIR_SYSTEM.'library/d_shopunity/extension/'.$this->codename.'lite.json'), true);
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('common/home', $this->model_extension_d_opencart_patch_user->getUrlToken(), 'SSL')
        );
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link($this->route, $this->model_extension_d_opencart_patch_user->getUrlToken() . $url, 'SSL')
        );
