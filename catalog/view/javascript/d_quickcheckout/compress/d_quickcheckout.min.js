...
o[this.name].push(this.value||'');}else{o[this.name]=this.value||'';}});return o;};function preloaderStart(){$('#qc_confirm_order').prop('disabled',true);if($('#qc_confirm_order:hover').length>0)qc.confirmOrderVar=1;else qc.confirmOrderVar=0;$('.preloader').delay(500).fadeIn(300);}
