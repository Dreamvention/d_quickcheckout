...
if(parseInt(config.general.analytics_event)){ga('send','event',config.name,'click','confirm.confirm');}},paymentConfirm:function(){console.log('confirm:paymentConfirm');preloaderStart();$(document).ajaxStop(function(){preloaderStop();});},changeAccount:function(account){if(this.model.get('account')!==account){this.model.changeAccount(account);this.render();}},update:function(data){this.model.set('data',data);var that=this;if(data.confirm){this.model.set('confirm',data.confirm);}
