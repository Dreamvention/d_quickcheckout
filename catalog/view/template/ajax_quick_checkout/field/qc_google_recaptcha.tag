<qc_field_google_recaptcha>
    ...
    <qc_google_recaptcha_setting  if={riot.util.tags.selectTags().search('"qc_google_recaptcha_setting"') && getState().edit} field_id="{opts.field_id}" field="{opts.field}" step="{opts.step}" ondelete="{opts.ondelete}" ></qc_google_recaptcha_setting>

    <qc_pro_label if={ riot.util.tags.selectTags().search('"qc_google_recaptcha_setting"') < 0 && getState().edit}></qc_pro_label>
