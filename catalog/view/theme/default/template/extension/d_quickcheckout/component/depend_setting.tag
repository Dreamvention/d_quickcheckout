        ...
        <div 
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <div>
                        <switcher onclick="{parent.opts.edit}" name="config[{getAccount()}][{parent.opts.step}][fields][{ parent.opts.field_id }][depends][{parent.opts.depend_id}][{depend_value_id}][display]" data-label-text="Enabled" value="{ depend_value.display }" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div>
                        <switcher onclick="{parent.opts.edit}" name="config[{getAccount()}][{parent.opts.step}][fields][{ parent.opts.field_id }][depends][{parent.opts.depend_id}][{depend_value_id}][require]" data-label-text="Enabled" value="{ depend_value.require }" />
                    </div>
                </div>
            </div>
        </div>
