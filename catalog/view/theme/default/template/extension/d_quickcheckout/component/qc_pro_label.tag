<qc_pro_label>
    ...
    <div class="get-pro">
        ...
        <div class="get-pro-heading">Get more settings in PRO</div>
        <div class="get-pro-text">Wherever you see this label, there is a setting waiting for you! Unlock PRO features like field settings and sorting, step settings, page settings, layouts and themes. </div>
