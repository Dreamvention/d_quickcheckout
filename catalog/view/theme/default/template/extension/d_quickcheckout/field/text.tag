<field_text>
    ...
    <text_setting if={riot.util.tags.selectTags().search('"text_setting"') && getState().edit} field_id="{opts.field_id}" field="{opts.field}" step="{opts.step}" ondelete="{opts.ondelete}"></text_setting>
