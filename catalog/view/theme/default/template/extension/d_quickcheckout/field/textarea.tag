<field_textarea>
    ...
    <textarea_setting if={riot.util.tags.selectTags().search('"textarea_setting"') && getState().edit} field_id="{opts.field_id}" field="{opts.field}" step="{opts.step}"></textarea_setting>
