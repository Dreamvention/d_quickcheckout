<account>
    <div class="step">
        ...
        <account_setting if={riot.util.tags.selectTags().search('"account_setting"') && getState().edit} step="{opts.step}"></account_setting>

        <pro_label if={ riot.util.tags.selectTags().search('"account_setting"') < 0 && getState().edit}></pro_label>
            ...
            <div class="panel panel-default" if={getState().config.guest.account.login_popup != 1 && getState().config.guest.account.option.login.display == 1 }>
                ...
                <div class="panel-body">
                    ...
                    <div if={getState().config.guest.account.social_login.display == 1 && getState().config.guest.account.social_login.value} class="row form-group clearfix qc-social-login">
                        <div class="col-md-12">
                            <raw content="{getState().config.guest.account.social_login.value}"></raw>
                        </div>
                    </div>
                    <form class="row">
                        <div class="form-group clearfix">
                            ...
                            <div class="col-md-7">
                                <input ref="email" type="text" class="form-control" name="email" value="">
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            <label class="col-md-5">{getLanguage().account.entry_password}</label>
                            <div class="col-md-7">
                                <input ref="password" type="password" class="form-control" name="password" value="">
                            </div>
                        </div>
