<cart>
    <div class="step">
        ...
        <cart_setting if={riot.util.tags.selectTags().search('"cart_setting"') && getState().edit} step="{opts.step}"></cart_setting>

        <pro_label if={ riot.util.tags.selectTags().search('"cart_setting"') < 0 && getState().edit}></pro_label>
