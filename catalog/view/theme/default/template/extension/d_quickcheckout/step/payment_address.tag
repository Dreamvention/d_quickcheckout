<payment_address>
    <div class="step">
        ...
        <payment_address_setting if={riot.util.tags.selectTags().search('"payment_address_setting"') && getState().edit} step="{opts.step}"></payment_address_setting>

        <pro_label if={ riot.util.tags.selectTags().search('"payment_address_setting"') < 0 && getState().edit}></pro_label>
        ...
        <div class="panel panel-default" show={getConfig().payment_address.display == 1}>
            ...
            <div class="panel-body">
                ...
                address_id={ getSession().payment_address.address_id }></address_radio>

                <address_select 
                if={getSession().addresses && getConfig().payment_address.address_style == 'select'} 
                step="payment_address" 
                address_id={ getSession().payment_address.address_id }></address_select>
                ...
                <div class="row { (getAccount() != 'logged' 
                    ...
                    <form id="payment_address_fields" class="payment-address-fields" >
                        ...
                        <div
                            ...
                            no-reorder
                            data-is={ getConfig().payment_address.fields[field_id].type ? 'field_' + getConfig().payment_address.fields[field_id].type : '' }
                        ></div>
                    </form>
                    <div class="col-md-12">
                        <custom_field if={getState().edit} setting_id="payment_address_custom_field" step="payment_address" location_account="true" location_address="true" onchange={updateFields}></custom_field>
                    </div>
                </div>
    ...
    <script>
        this.setting_id = 'payment_address_setting';
