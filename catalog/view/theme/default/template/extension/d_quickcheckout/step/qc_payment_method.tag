<qc_payment_method>
    <div class="step">
        ...
        <!-- Step -->
        <div class="ve-card payment-method" show={getConfig().payment_method.display == 1}>
            ...
            <div class="ve-card__section">
                ...
                <form id="payment_method_list" if={getConfig().payment_method.display_options == 1 && getSession().payment_methods}>
                    <div if={getConfig().payment_method.input_style == 'radio'}  each={ payment_method, name in getSession().payment_methods } class="ve-field" >
                    ...
                    <select if={getConfig().payment_method.input_style == 'select'} class="ve-input" name="payment_method" onchange={change}>
                        <option 
                            if={ payment_method}
