<shipping_address>
    <div class="step">
        ...
        <shipping_address_setting if={riot.util.tags.selectTags().search('"shipping_address_setting"') && getState().edit} step="{opts.step}"></shipping_address_setting>

        <pro_label if={ riot.util.tags.selectTags().search('"shipping_address_setting"') < 0 && getState().edit}></pro_label>
                ...
                <div class="row" 
                    ...
                    <form id="shipping_address_fields" class="shipping-address-fields">
                        <div
                            ...
                            data-is={ getConfig().shipping_address.fields[field_id].type ? 'field_' + getConfig().shipping_address.fields[field_id].type : '' }
                        ></div>
                    </form>
                    <div class="col-md-12">
